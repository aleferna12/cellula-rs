...
[basic example](https://github.com/aleferna12/cellula-rs/blob/master/cellulars/examples/basic.rs),
...
Alternatively, we provide a [template repo](https://github.com/aleferna12/cellulars-template)
