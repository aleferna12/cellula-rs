...
* require that \p splitPoint is exactly on the segment. However,
* the \p splitPoint must have an orthogonal projection ON the segment.
*
* @return a pointer to the inserted vertex or NULL if the operation
* was not successful.
*
