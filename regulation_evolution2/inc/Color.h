...
* @param bFill_ fill (default: \e false) has two meanings: Objects that have an
* area, like Triangle2, Circle2 and VoroCell2, are filled with the specified rgb-color
* while line segments with \p bFill=true will be drawn with x-marks at their endpoints.
*/
