...
/** \brief Get the 3 triangle corners
 */
...
*
* @param [out] ccq returns the quality of the computed point and is one
...
/** \brief Has on (triangle)
 *
 * \return if \p q is on the triangle
 *
 * @if SECTION_FADE25D
 * This is a 2D test i.e., z coordinate is not evaluated
 * @endif
