...
/** \brief Check if an edge is a constraint segment
*
* Checks if the edge (p0,p1) is a constraint segment of the present
* ConstraintGraph2 object. The order of p0 and p1 does not matter.
*/
	CLASS_DECLSPEC
