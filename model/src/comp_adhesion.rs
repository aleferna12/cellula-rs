...
impl AdhesionSystem for CompAdhesion {
...
mod tests {
    ...
    fn test_complementarity() {
        assert_eq!(0, CompAdhesion::complementarity(0, 0));
        assert_eq!(0, CompAdhesion::complementarity(255, 255));
        assert_eq!(8, CompAdhesion::complementarity(255, 0));
        assert_eq!(5, CompAdhesion::complementarity(250, 103));
    }
